...
def test_zero_in_zero():
    x = IrrepsData.from_list("0e + 0o + 0o + 0e", [jnp.ones((1, 1)), None, None, None])
...
def test_irreps_argument():
    assert scalar_activation("0e + 0o + 0o + 0e", [jnp.tanh, jnp.tanh, lambda x: x**2, jnp.cos]) == Irreps("0e + 0o + 0e + 0e")
